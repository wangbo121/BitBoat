...
const BIT_Scheduler::Task Boat::scheduler_tasks[] =
{
    ...
    { SCHED_TASK(write_device_motors_output),                                  20,      200 },
    ...
    { SCHED_TASK(update_navigation_loop),                                       1,      200 },

    { SCHED_TASK(send_ap2gcs_realtime_data_boatlink_by_udp),                    1,      200 },
#endif
...
#define MAINTASK_TICK_TIME_US 10000  // 10000us 100hz
int micro_seconds = MAINTASK_TICK_TIME_US; /*每个tick对应的微秒数*/
...
void Boat::loop( void )
{
    ...
    //printf("loop_fast   : time_available = %d \n", time_available);
